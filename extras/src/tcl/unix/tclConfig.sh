...
#
# RCS: @(#) $Id: tclConfig.sh,v 1.1.1.1 2009/03/23 15:10:41 duncan Exp $
...
# installed.
TCL_PREFIX='/usr/people/duncan/src/fsldev'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/usr/people/duncan/src/fsldev'
...
TCL_EXTRA_CFLAGS=' -pipe -I/usr/local/fsl/extras/include'
...
TCL_LD_FLAGS='-L/usr/local/fsl/extras/lib -Wl,--export-dynamic'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/usr/people/duncan/src/FMRIB/fsldev/tcl8.4.19/unix -ltcl8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/usr/people/duncan/src/fsldev/lib -ltcl8.4${TCL_DBGX}'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/usr/people/duncan/src/fsldev/include'
...
# compiled.
TCL_SRC_DIR='/usr/people/duncan/src/FMRIB/fsldev/tcl8.4.19'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/usr/people/duncan/src/fsldev/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/usr/people/duncan/src/FMRIB/fsldev/tcl8.4.19/unix -ltclstub8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/usr/people/duncan/src/fsldev/lib -ltclstub8.4${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/usr/people/duncan/src/FMRIB/fsldev/tcl8.4.19/unix/libtclstub8.4${TCL_DBGX}.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/usr/people/duncan/src/fsldev/lib/libtclstub8.4${TCL_DBGX}.a'
